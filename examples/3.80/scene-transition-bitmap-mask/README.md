...
You can see a live demo of the example here: <a href="https://devshareacademy.github.io/phaser-3-typescript-games-and-examples/examples/scene-transition-bitmap-mask/index.html" target="_blank">Phaser 3 Scene Transition Bitmap Mask</a>

![Example](https://devshareacademy.github.io/cdn/images/documentation/examples/scene-transition-bitmap-mask/example.gif?raw=true)
