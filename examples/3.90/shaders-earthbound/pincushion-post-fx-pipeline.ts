...
export class PincushionPostFxPipeline extends Phaser.Renderer.WebGL.Pipelines.PostFXPipeline {
  strength: number = 0.5;
  scrollSpeed: number = 0.2;
  curve: number = 2.0; // Default to a parabolic curve

  constructor(game: Phaser.Game) {
    super({
      game,
      fragShader,
      name: 'PincushionPostFxPipeline',
    });
  }
